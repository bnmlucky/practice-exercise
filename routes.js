...
router.get('/', (req, res) => {
    ...
    const reverseGreeting = helpers.reverseString(greeting);
    const shortenedDesc = helpers.shortenString('Lorem ipsum dolor sit amet, consectet');
...
router.get('/error', (req, res) => {
    // Log statement to indicate that this function is running
    console.log('Handling rquest to custom "error" route, "/error"');
